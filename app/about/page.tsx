...
import { MoussyEvent, Presentation, Speech, Owner } from "@/images";

export const generateMetadata = getSeoForPage("/about");
  ...
  return (
    <Page>
      ...
      <Section
        ...
        graphicUrl={"MoussyEvent"}
        graphicId="section-1-graphic"
